...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dataUpdated((*reinterpret_cast<std::add_pointer_t<QList<double>>>(_a[1]))); break;
        case 1: _t->processRawData((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(const QVector<double> & )>(_a, &DataProcessor::dataUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void DataProcessor::dataUpdated(const QVector<double> & _t1)
{
